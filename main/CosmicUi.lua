...
function ret:Library(Name)
	...
	Notifications.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
	...
	NoteSample.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
	NoteSample.BackgroundTransparency = 1.000
	NoteSample.BorderSizePixel = 0
	NoteSample.Position = UDim2.new(0, -1850, 50, 50)
	...
	textName.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
	...
	function ui:Note(Title,Message,Error)
        ...
        Note.Position = UDim2.new(50, 50, 50, 0)
        Note.Frame.Position = UDim2.new(-1, 50, 50, 50)
        ...
        while true do
            ...
            T3 = T4
            rtbl[T5] = rtbl[T5] - UDim2.new(50, 50, 50, 42)
        ...
        Note.Frame:TweenPosition(UDim2.new(50, 50, 50, 0), "Out", "Back", 0.5, true)

        task.spawn(function()
            task.wait(8)
            Note.Frame:TweenPosition(UDim2.new(-1.1, 50, 50, 50), "Out", "Quad", 1, true)
            task.wait(1)
            Note:Destroy()
            rtbl[Note] = nil
        end)
	...
	function ui:Window(rbrbrb)
		...
		Window1.Parent = aui
		Window1.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
		Window1.BackgroundTransparency = 1
		Window1.BorderColor3 = Color3.fromRGB(50, 50, 50)
		...
		TextLabel.Position = UDim2.new(0.0450000018, 50, 50, 50)
		...
		Min.BorderColor3 = Color3.fromRGB(50, 50, 50)
		...
		Max.Name = "Max"
		Max.Parent = Top
		Max.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
		Max.BorderColor3 = Color3.fromRGB(50, 50, 50)
		...
		Max.Text = ""
		Max.TextColor3 = Color3.fromRGB(50, 50, 50)
		Max.TextSize = 35.000
		...
		function self:Toggle(name,b,f)
			...
			TextButton.Position = UDim2.new(0.026041666, 50, 50, 50)
		...
		function self:Label(text)
			...
			Label.Position = UDim2.new(50, 50, 50, 48)
		...
		function self:Slider(n,min,max,default,precise,f)
			...
			Slider.Position = UDim2.new(50, 50, 50, 72)
			...
			SliderFrame.Position = UDim2.new(0.026041666, 50, 50, 50)
			...
			SliderFrame.TextColor3 = Color3.fromRGB(50, 50, 50)
		...
		function self:TextBox(n,find,f)
			...
			Textbox.Position = UDim2.new(50, 50, 50, 168)
			...
			TextBox.Position = UDim2.new(0.0267857146, 50, 50, 50)
			...
			TextLabel.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			TextLabel.BackgroundTransparency = 1.000
			TextLabel.Position = UDim2.new(0.0267857146, 50, 50, 50)
			TextLabel.Size = UDim2.new(0, 148, 0, 20)
			TextLabel.Font = Enum.Font.SourceSansBold
			TextLabel.Text = ""
		...
		function self:Dropdown(n,l,f)
			...
			Dropdown.Position = UDim2.new(50, 50, 50, 24)
			...
			TextLabel.BackgroundTransparency = 1.000
			TextLabel.BorderSizePixel = 3
			TextLabel.Position = UDim2.new(0.026041666, 50, 50, 50)
			...
			DFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			local function add(thing)
				...
				OptionParent.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
		...
		function self:SplitFrame()
			...
			SplitHolder.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			function self2:Button(n,f)
				...
				if g <= 2 then
					...
					TextButton.BackgroundTransparency = 1.000
					TextButton.BorderSizePixel = 3
					TextButton.Position = UDim2.new(50, 50, 50, 0)
					TextButton.Size = UDim2.new(0, 148/2, 0, 20)
					TextButton.Font = Enum.Font.SourceSansBold
					TextButton.TextColor3 = Color3.fromRGB(50, 50, 50)
					TextButton.Text = tostring(n)
			...
			function self2:Slider(n,min,max,default,precise,f)
				...
				if g <= 2 then
					...
					Slider.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
					Slider.BorderColor3 = Color3.fromRGB(23, 25, 52)
					Slider.Position = UDim2.new(50, 50, 50, 0)
					...
					SliderFrame.BackgroundTransparency = 1.000
					SliderFrame.BorderSizePixel = 3
					SliderFrame.Position = UDim2.new(50, 50, 50, 0)
			...
			function self2:TextBox(n,find,f)
				...
				if g <= 2 then
					...
					Textbox.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
					Textbox.BorderColor3 = Color3.fromRGB(23, 25, 52)
					Textbox.Position = UDim2.new(50, 50, 50, 0)
