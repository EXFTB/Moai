...
function ret:Library(Name)
	...
	Notifications.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	...
	NoteSample.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	NoteSample.BackgroundTransparency = 1.000
	NoteSample.BorderSizePixel = 0
	NoteSample.Position = UDim2.new(0, -1825, 25, 25)
	...
	textName.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	...
	function ui:Note(Title,Message,Error)
        ...
        Note.Position = UDim2.new(25, 25, 25, 0)
        Note.Frame.Position = UDim2.new(-1, 25, 25, 25)
        ...
        while true do
            ...
            T3 = T4
            rtbl[T5] = rtbl[T5] - UDim2.new(25, 25, 25, 42)
        ...
        Note.Frame:TweenPosition(UDim2.new(25, 25, 25, 0), "Out", "Back", 0.5, true)

        task.spawn(function()
            task.wait(8)
            Note.Frame:TweenPosition(UDim2.new(-1.1, 25, 25, 25), "Out", "Quad", 1, true)
            task.wait(1)
            Note:Destroy()
            rtbl[Note] = nil
        end)
	...
	function ui:Window(rbrbrb)
		...
		Window1.Parent = aui
		Window1.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		Window1.BackgroundTransparency = 1
		Window1.BorderColor3 = Color3.fromRGB(25, 25, 25)
		...
		TextLabel.Position = UDim2.new(0.0450000018, 25, 25, 25)
		...
		Min.Name = "Min"
		Min.Parent = Top
		Min.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		Min.BorderColor3 = Color3.fromRGB(25, 25, 25)
		...
		Min.Text = "-"
		Min.TextColor3 = Color3.fromRGB(25, 25, 25)
		Min.TextSize = 39.000

		Max.Name = "Max"
		Max.Parent = Top
		Max.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		Max.BorderColor3 = Color3.fromRGB(25, 25, 25)
		...
		Max.Text = ""
		Max.TextColor3 = Color3.fromRGB(25, 25, 25)
		Max.TextSize = 35.000
		...
		Holder.Name = "Holder"
		Holder.Parent = Top
		Holder.Position = UDim2.new(25, 25, 25, 26)
		...
		function self:Toggle(name,b,f)
			...
			TextButton.Position = UDim2.new(0.026041666, 25, 25, 25)
			TextButton.Size = UDim2.new(0, 148, 0, 20)
			TextButton.Font = Enum.Font.SourceSansBold
			TextButton.Text = tostring(name)
			TextButton.TextColor3 = Color3.fromRGB(25, 25, 25)
		...
		function self:Label(text)
			...
			Label.Position = UDim2.new(25, 25, 25, 48)
		...
		function self:Slider(n,min,max,default,precise,f)
			...
			Slider.Position = UDim2.new(25, 25, 25, 72)
			...
			SliderFrame.Position = UDim2.new(0.026041666, 25, 25, 25)
			...
			SliderFrame.TextColor3 = Color3.fromRGB(25, 25, 25)
		...
		function self:TextBox(n,find,f)
			...
			Textbox.Position = UDim2.new(25, 25, 25, 168)
			...
			TextBox.Position = UDim2.new(0.0267857146, 25, 25, 25)
			...
			TextLabel.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			TextLabel.BackgroundTransparency = 1.000
			TextLabel.Position = UDim2.new(0.0267857146, 25, 25, 25)
			TextLabel.Size = UDim2.new(0, 148, 0, 20)
			TextLabel.Font = Enum.Font.SourceSansBold
			TextLabel.Text = ""
		...
		function self:Dropdown(n,l,f)
			...
			Dropdown.Position = UDim2.new(25, 25, 25, 24)
			...
			TextLabel.BackgroundTransparency = 1.000
			TextLabel.BorderSizePixel = 3
			TextLabel.Position = UDim2.new(0.026041666, 25, 25, 25)
			...
			local function add(thing)
				...
				OptionParent.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		...
		function self:SplitFrame()
			...
			SplitHolder.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			function self2:Button(n,f)
				...
				if g <= 2 then
					...
					TextButton.BackgroundTransparency = 1.000
					TextButton.BorderSizePixel = 3
					TextButton.Position = UDim2.new(25, 25, 25, 0)
					TextButton.Size = UDim2.new(0, 148/2, 0, 20)
					TextButton.Font = Enum.Font.SourceSansBold
					TextButton.TextColor3 = Color3.fromRGB(25, 25, 25)
					TextButton.Text = tostring(n)
			...
			function self2:Slider(n,min,max,default,precise,f)
				...
				if g <= 2 then
					...
					Slider.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
					Slider.BorderColor3 = Color3.fromRGB(23, 25, 52)
					Slider.Position = UDim2.new(25, 25, 25, 0)
					...
					SliderFrame.BackgroundTransparency = 1.000
					SliderFrame.BorderSizePixel = 3
					SliderFrame.Position = UDim2.new(25, 25, 25, 0)
			...
			function self2:TextBox(n,find,f)
				...
				if g <= 2 then
					...
					Textbox.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
					Textbox.BorderColor3 = Color3.fromRGB(23, 25, 52)
					Textbox.Position = UDim2.new(25, 25, 25, 0)
